...
This is a sample template for TestWatchServerless - Below is a brief explanation of what we have generated for you:
...
aws cloudformation describe-stacks \
    --stack-name testwatchserverless --query 'Stacks[].Outputs'
```
